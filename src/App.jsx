...
function App() {
  ...
  // если все плитки открыты и совпали – вин
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 gap-4">
      ...
      <header className="text-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-[1.15] py-1 inline-block mb-2">
          Найди пару!
        </h1>
